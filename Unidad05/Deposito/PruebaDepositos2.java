...
public class PruebaDepositos2 {
   ...
   static String justificacionAccionDeposito= "%-" + LONG_MARGEN + "s";
    ...
    public static void main(String[] args) {
        ...
        Deposito[] listaDep= {null, null, null, null, null, null, null};
        String[] nombreDep= {"dep0", "dep1", "dep2", "dep3", "dep4", "dep5", "dep6"};
        ...
        System.out.println ("----------------------------");
        System.out.print (String.format (justificacionAccionDeposito, "Fabricación dep0 (1,5,0.1): "));
        try {
        ...
        System.out.println ("----------------------------");
        System.out.print (String.format (justificacionAccionDeposito, "Fabricación dep1 (1,0.25,0.1): "));
        try {
        ...
        System.out.println ("----------------------------");
        System.out.print (String.format (justificacionAccionDeposito, "Fabricación dep2 (1,0.25,0.1): "));
        try {
        ...
        System.out.println ("----------------------------");
        System.out.print (String.format (justificacionAccionDeposito, "Fabricación dep3 (0.4,0.2,1): "));
        try {
        ...
        abrirGrifoDeposito (listaDep[3], 0);
        ...
        System.out.println ("----------------------------");
        System.out.print (String.format (justificacionAccionDeposito, "Fabricación dep4 (0.8,0.2,0.1): "));
        try {
        ...
        System.out.println ("----------------------------");
        System.out.print (String.format (justificacionAccionDeposito, "Fabricación dep5 (1,0.5): "));
        try {
        ...
        vaciarDeposito(listaDep[5]);
        vaciarDeposito(listaDep[5]);
        abrirGrifoDeposito (listaDep[5], 0);        
        ...
        // PRUEBAS CON dep6
        //-------------------------------------------------------
        // Pruebas con el depósito Dep6
        System.out.println ();
        System.out.println ("PRUEBAS CON EL DEPÓSITO dep6");
        System.out.println ("----------------------------");
        System.out.print (String.format (justificacionAccionDeposito, "Fabricación dep6 (clon dep1): "));
        try {
            listaDep[6]= new Deposito (listaDep[1]);
            System.out.println("Depósito creado sin error.");            
        } catch (IllegalArgumentException e) {
            // Error al crear el depósito con los parámetros proporcionados
            // Creamos el depósito con el constructor por defecto
            System.out.println (e.getMessage());
            System.out.println (" Se crea el depósito con los valores por defecto.");
            listaDep[6]= new Deposito ();
        } finally {
            System.out.println (margenEstadoDeposito + listaDep[6].toString());            
        }
        
        // Informe final
        System.out.print (generaInformeDeposito (listaDep[6], nombreDep[6]));
        System.out.print (generaInformeTotalDepositos());
    ...
    private static String generaInformeDeposito (Deposito deposito, String nombreDeposito) {
        ...
        if (deposito!=null) {
            ...
            informe.append ("\nNúmero de depósitos completamente llenos: ").append (Deposito.getNumDepositosLlenos());
            informe.append ("\nDepósito vacío: ").append (deposito.estaVacio());
            informe.append ("\nNúmero de depósitos completamente vacíos: ").append (Deposito.getNumDepositosVacios());        
        }
        else {
